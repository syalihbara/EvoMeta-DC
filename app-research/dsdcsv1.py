...
class UnifiedDrivingCycleGenerator:
    ...
    def generate_comprehensive_dataset(self, n_cycles_per_domain=2, duration_range=(300, 600)):
        """Generate dataset komprehensif dengan semua metode dan domain"""
        domains = list(self.domain_characteristics.keys())
        ...
        print(f"📈 Cycles per domain: {n_cycles_per_domain}")
        ...
        for domain in domains:
            ...
            for method in methods:
                ...
                for i in range(n_cycles_per_domain):
...
def demonstrate_unified_generator():
    ...
    dataset = generator.generate_comprehensive_dataset(
        n_cycles_per_domain=2,  # 2 cycles per domain per method
        duration_range=(300, 500)  # 5-8 minutes per cycle
    )
